...
// Make this page non-prerendered
export const dynamic = "force-dynamic";
// If you prefer explicit: export const revalidate = false;
    ...
    <main className="min-h-dvh w-screen bg-gray-900 text-white grid place-items-center p-6">
      <div className="w-full max-w-3xl space-y-6 text-center">
        ...
        <div className="flex gap-3 justify-center">
          <button className="btn" onClick={() => r.push("/leaderboard")}>View Leaderboard</button>
    ...
    <Suspense
      fallback={
        <main className="min-h-dvh w-screen bg-gray-900 text-white grid place-items-center p-6">
          <div className="w-full max-w-3xl space-y-6 text-center">
            <h1 className="text-3xl font-bold">🏁 Quest Complete!</h1>
            <div className="panel text-2xl animate-pulse">Time: …</div>
          </div>
        </main>
      }
    >
